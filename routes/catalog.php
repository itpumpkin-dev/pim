...
Route::middleware(['auth'])->prefix('catalog')->name('catalog.')->group(function () {
    ...
    Route::post('attributes/woocommerce-mapping/attribute-family', [WooCommerceAttributeMappingController::class, 'syncAttributeFamily'])->name('attributes.woocommerceSyncAttributeFamily')->middleware('permission:marketplace_woocommerce,edit_attribute_mapping_woocommerce');
