...
class DashboardController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        $categoryStat = $this->cachedStat('category', Category::query());
        $attributeStat = $this->cachedStat('attribute', Attribute::query());
        $groupStat = $this->cachedStat('attribute_group', AttributeGroup::query());
        $familyStat = $this->cachedStat('attribute_family', AttributeFamily::query());
        $localeStat = $this->cachedStat('locale', Locale::query());
        $currencyStat = $this->cachedStat('currency', Currency::query());
        $channelStat = $this->cachedStat('channel', Channel::query());
        ...
        $failedJobsCount = $this->cacheRemember('failedJobs', fn () => JobTracker::where('status', 'failed')->count());
