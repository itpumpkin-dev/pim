                ...
                'groups' => [
                    ...
                    [
                        ...
                        'operations' => [
                            ...
                            ['method' => 'POST', 'endpoint' => '/api/v2/product/unlist_item', 'purpose' => 'Deactivate/hide a listing (reversible — the item_id still exists)', 'source' => 'ShopeeClient::unlistItem() → ShopeeProductSyncService::deactivate() → ProductController::deactivateShopee()', 'write' => true],
                            ['method' => 'POST', 'endpoint' => '/api/v2/product/delete_item', 'purpose' => 'Permanently delete a listing (irreversible — distinct from unlist_item\'s hide; available, no controller call yet)', 'source' => 'ShopeeClient::deleteItem()', 'write' => true],
                        ],
                    ],
                ],
            ],
