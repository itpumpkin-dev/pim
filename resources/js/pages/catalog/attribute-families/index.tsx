                                ...
                                <TableRow key={row.id} hover>
                                    ...
                                    <TableCell align="right">
                                        <Stack direction="row" spacing={1} justifyContent="flex-end">
                                            {canEdit && (
                                                <IconButton size="small" sx={{ color: '#64748b' }} onClick={() => router.visit(`/catalog/attributeFamilies/${row.id}/edit`)}>
                                            ...
                                            {canDelete && (
                                                <IconButton size="small" sx={{ color: '#64748b' }} onClick={() => setDeleteFamilyId(row.id)}>
