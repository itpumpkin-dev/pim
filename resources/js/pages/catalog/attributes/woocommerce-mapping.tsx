...
export default function WooCommerceAttributeMapping({ attributes, wooCommerceAttributes }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: t('woocommerceContentMapping'), href: '#' },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={t('woocommerceContentMapping')} />
            <Box sx={{ p: 4 }}>
                <Stack direction="row" justifyContent="space-between" alignItems="flex-start" sx={{ mb: 3 }}>
                    <Box>
                        ...
                        <Typography variant="h4" fontWeight={700}>{t('woocommerceContentMapping')}</Typography><Divider sx={{ my: 1 }} />
