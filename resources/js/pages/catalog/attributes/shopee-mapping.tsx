...
export default function ShopeeAttributeMapping({ attributes, shopeeAttributes }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: t('shopeeAttributeMapping'), href: '#' },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={t('shopeeAttributeMapping')} />
            <Box sx={{ p: 4 }}>
                <Stack direction="row" justifyContent="space-between" alignItems="flex-start" sx={{ mb: 3 }}>
                    <Box>
                        ...
                        <Typography variant="h4" fontWeight={700}>{t('shopeeAttributeMapping')}</Typography><Divider sx={{ my: 1 }} />
