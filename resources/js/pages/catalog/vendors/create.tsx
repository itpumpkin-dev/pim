...
export default function VendorCreate({ currencies }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: t('createVendor'), href: '/catalog/vendors/create' },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={t('createVendor')} />
            <Box component="form" onSubmit={submit} sx={{ p: { xs: 2, md: 4 }, width: '100%', maxWidth: 760, bgcolor: FIORI.pageBg }}>
                <Stack direction={{ xs: 'column', sm: 'row' }} justifyContent="space-between" alignItems={{ sm: 'center' }} spacing={2} sx={{ mb: 3 }}>
                    <Typography variant="h5" fontWeight={600} sx={{ color: FIORI.textPrimary }}>{t('createVendor')}</Typography>
                ...
                <Stack spacing={2}>
                    ...
                    <FioriFormGroup title={t('contactInfoTitle')}>
                        ...
                        <FioriField label={t('contactAddress')} htmlFor="v-contact-address-1" valueState={valueStateOf(errors.contact_address_1)} message={errors.contact_address_1} hint={t('contactAddressLine1')}>
